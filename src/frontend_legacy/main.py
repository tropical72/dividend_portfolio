...
class DividendApp(MDApp):
        ...
        menu_items = [
            {
                ...
                "text": "US",
                "on_release": lambda x="US": self.set_item(x),
            },
            {
                "viewclass": "OneLineListItem",
                "text": "KR",
            ...
            items=[
                {
                    "viewclass": "OneLineListItem",
                    "text": opt,
                    "on_release": lambda x=opt: self.apply_sort(x),
                }
            ...
            items=[
                {
                    "viewclass": "OneLineListItem",
                    "text": opt,
                    "on_release": lambda x=opt: self.apply_rows_num(x),
                }
    ...
    def refresh_table(self, rebuild=False):
        ...
        widths = settings.get(
            "column_widths",
            {"ticker": 30, "name": 85, "price": 40, "yield": 45, "rtn": 45, "date": 55},
        )
