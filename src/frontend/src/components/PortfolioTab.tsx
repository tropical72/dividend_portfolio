...
export function PortfolioTab({
  ...
  const copy = isKorean
    ? {
        defaultName: "새 포트폴리오",
        loaded: t("portfolio.status.loaded"),
        inputTickerAndName: t("portfolio.status.inputTickerAndName"),
        itemAdded: t("portfolio.status.itemAdded"),
        resetConfirm: t("portfolio.status.resetConfirm"),
        resetDone: t("portfolio.status.resetDone"),
        addItemsFirst: t("portfolio.status.addItemsFirst"),
        nameRequired: t("portfolio.status.nameRequired"),
        weightMustBe100: t("portfolio.status.weightMustBe100"),
        updated: t("portfolio.status.updated"),
        savedNew: t("portfolio.status.savedNew"),
        saveFailed: t("portfolio.status.saveFailed"),
        serverError: t("portfolio.status.serverError"),
