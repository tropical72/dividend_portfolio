...
const translations = {
  en: {
    ...
    "watchlist.addDone": "Added",
    "watchlist.addFailed": "Add failed",
    "watchlist.serverError": "Server communication error",
    "watchlist.deleteDoneSuffix": " stocks deleted",
    "watchlist.partialDeleteFailed": "Partial delete failed",
    "watchlist.deleteError": "An error occurred while deleting.",
    "watchlist.deleteSelected": " Delete",
    "watchlist.confirmDelete": "Delete this item?",
    "watchlist.deleteSelectedDesc": "Remove all selected items.",
    "watchlist.deleteOneSuffix": " will be removed.",
    "watchlist.cancel": "Cancel",
    "watchlist.delete": "Delete",
    "watchlist.selectCategory": "Select Category",
    "watchlist.addToWhichCategory":
      "Which category should receive the selected stocks?",
    "watchlist.addToPortfolio": "Add to Portfolio",
    "watchlist.cannotDeleteDefault": "Default stocks cannot be deleted",
    "watchlist.deleteStock": "Delete Stock",
    "watchlist.title": "Watchlist",
    "watchlist.addSelected": "Add to Portfolio",
    "watchlist.enterTicker": "Enter Ticker",
    "watchlist.adding": "Adding...",
    "watchlist.add": "Add",
    "watchlist.selectAllStocks": "Select all stocks",
    "watchlist.name": "Name",
    "watchlist.price": "Price",
    "watchlist.yield": "Yield",
    "watchlist.cycle": "Cycle",
    "watchlist.oneYearReturn": "1-Yr Rtn",
    "watchlist.exDiv": "Ex-Div",
    "watchlist.lastAmount": "Last Amt",
    "watchlist.monthly": "Monthly",
    "watchlist.action": "Act",
    "watchlist.noStocks": "No stocks added yet.",
    "watchlist.corpSgovDesc": "Survival buffer and cash waiting assets",
    "watchlist.corpBondDesc": "Bond-based mid-term buffer",
    "watchlist.corpHighIncomeDesc": "High-income cashflow block",
    "watchlist.dividendGrowthDesc": "Dividend growth support assets",
    "watchlist.corpGrowthDesc": "Last-resort growth engine",
    "watchlist.pensionSgovDesc": "Short-term withdrawal buffer",
    "watchlist.pensionBondDesc": "Mid-term bond buffer",
    "watchlist.pensionGrowthDesc": "Late-retirement growth engine",
    "portfolio.status.loaded": "loaded",
    "portfolio.status.inputTickerAndName": "Enter both ticker and stock name.",
    "portfolio.status.itemAdded": "Asset added.",
    "portfolio.status.resetConfirm":
      "This will remove everything in the current design. Reset now?",
    "portfolio.status.resetDone": "Reset complete.",
    "portfolio.status.addItemsFirst": "Add assets first.",
    "portfolio.status.nameRequired": "Enter a portfolio name.",
    "portfolio.status.weightMustBe100":
      "Total allocation must be exactly 100%.",
    "portfolio.status.updated": "Updated.",
    "portfolio.status.savedNew": "Saved as a new portfolio.",
    "portfolio.status.saveFailed": "Save failed",
    "portfolio.status.serverError": "Server communication error",
    "portfolioDashboard.message.deleteMasterConfirm":
      "Delete this master strategy?",
    "portfolioDashboard.message.masterDeleteFailed":
      "Unable to delete the strategy.",
    "portfolioDashboard.message.deletePortfolioPrefix": "Delete portfolio ",
    "portfolioDashboard.message.deletePortfolioSuffix": "?",
    "portfolioDashboard.message.portfolioDeleteFailed":
      "Unable to delete the portfolio.",
    ...
    "retirement.activateFailed": "Unable to activate the strategy.",
  ...
  ko: {
    ...
    "app.watchlist": "관심종목",
    "watchlist.addDone": "추가 완료",
    "watchlist.addFailed": "추가 실패",
    "watchlist.serverError": "서버 통신 오류",
    "watchlist.deleteDoneSuffix": "개 종목 삭제 완료",
    "watchlist.partialDeleteFailed": "일부 삭제 실패",
    "watchlist.deleteError": "삭제 중 오류가 발생했습니다.",
    "watchlist.deleteSelected": "개 삭제",
    "watchlist.confirmDelete": "삭제하시겠습니까?",
    "watchlist.deleteSelectedDesc": "선택한 항목을 모두 제거합니다.",
    "watchlist.deleteOneSuffix": "종목을 제거합니다.",
    "watchlist.cancel": "취소",
    "watchlist.delete": "삭제",
    "watchlist.selectCategory": "카테고리 선택",
    "watchlist.addToWhichCategory": "선택한 종목을 어느 카테고리에 추가할까요?",
    "watchlist.addToPortfolio": "포트폴리오에 추가",
    "watchlist.cannotDeleteDefault": "기본 종목은 삭제할 수 없습니다",
    "watchlist.deleteStock": "종목 삭제",
    "watchlist.title": "관심종목",
    "watchlist.addSelected": "포트폴리오 추가",
    "watchlist.enterTicker": "티커 입력",
    "watchlist.adding": "추가 중...",
    "watchlist.add": "추가",
    "watchlist.selectAllStocks": "모든 종목 선택",
    "watchlist.name": "이름",
    "watchlist.price": "가격",
    "watchlist.yield": "배당률",
    "watchlist.cycle": "주기",
    "watchlist.oneYearReturn": "1년 수익률",
    "watchlist.exDiv": "배당락",
    "watchlist.lastAmount": "최근 금액",
    "watchlist.monthly": "월평균",
    "watchlist.action": "작업",
    "watchlist.noStocks": "추가된 종목이 없습니다.",
    "watchlist.corpSgovDesc": "생존 버퍼와 현금 대기 자산",
    "watchlist.corpBondDesc": "채권 기반 중기 완충 버퍼",
    "watchlist.corpHighIncomeDesc": "고인컴 현금흐름 블록",
    "watchlist.dividendGrowthDesc": "배당성장 보강 자산",
    "watchlist.corpGrowthDesc": "최후 보호 성장 엔진",
    "watchlist.pensionSgovDesc": "단기 인출 버퍼",
    "watchlist.pensionBondDesc": "중기 완충 채권 버퍼",
    "watchlist.pensionGrowthDesc": "은퇴 후반 성장 엔진",
    "portfolio.status.loaded": "로드 완료",
    "portfolio.status.inputTickerAndName": "티커와 종목명을 입력해주세요.",
    "portfolio.status.itemAdded": "종목이 추가되었습니다.",
    "portfolio.status.resetConfirm":
      "현재 작성 중인 내용이 모두 사라집니다. 초기화할까요?",
    "portfolio.status.resetDone": "초기화되었습니다.",
    "portfolio.status.addItemsFirst": "종목을 먼저 추가해주세요.",
    "portfolio.status.nameRequired": "포트폴리오 이름을 입력해주세요.",
    "portfolio.status.weightMustBe100": "비중 합계가 정확히 100%여야 합니다.",
    "portfolio.status.updated": "업데이트되었습니다.",
    "portfolio.status.savedNew": "새 포트폴리오로 저장되었습니다.",
    "portfolio.status.saveFailed": "저장 실패",
    "portfolio.status.serverError": "서버 통신 오류",
    "portfolioDashboard.message.deleteMasterConfirm":
      "이 마스터 전략을 삭제하시겠습니까?",
    "portfolioDashboard.message.masterDeleteFailed":
      "전략을 삭제할 수 없습니다.",
    "portfolioDashboard.message.deletePortfolioPrefix": '"',
    "portfolioDashboard.message.deletePortfolioSuffix":
      '" 포트폴리오를 삭제하시겠습니까?',
    "portfolioDashboard.message.portfolioDeleteFailed":
      "포트폴리오를 삭제할 수 없습니다.",
    ...
    "retirement.activateFailed": "전략을 활성화할 수 없습니다.",
