...
def test_portfolio_integration_yield_mapping(client):
    ...
    corp_p = {
        ...
        "currency": "KRW",
        "items": [
            {"symbol": "TEST1", "name": "High Div", "weight": 100, "dividend_yield": 10.0}
        ]
    }
    pen_p = {
        "id": "test-pen-p",
        ...
        "currency": "KRW",
        "items": [
            {"symbol": "TEST2", "name": "Low Div", "weight": 100, "dividend_yield": 2.0}
        ]
    }
    ...
    config = {
        "user_profile": {
            "birth_year": 1980, "birth_month": 1,
            "private_pension_start_age": 55, "national_pension_start_age": 65
        },
        "simulation_params": {
            "target_monthly_cashflow": 5000000,
            "simulation_start_year": 2026, "simulation_start_month": 1,
        ...
        "assumptions": {
            "v1": {"expected_return": 0.05, "inflation_rate": 0.02}
        },
        "active_assumption_id": "v1",
        "tax_and_insurance": {
            "point_unit_price": 200, "ltc_rate": 0.12,
            "corp_tax_threshold": 200000000, "corp_tax_low_rate": 0.1, "corp_tax_high_rate": 0.2,
            "pension_rate": 0.045, "health_rate": 0.035, "employment_rate": 0.009,
