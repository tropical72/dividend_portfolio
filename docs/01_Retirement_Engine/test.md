...
- **[TEST-SUR-39] 개인운용 2인 금융소득 건보 기준 [REGRESSION]:** 2인 Personal 운용에서 외부/운용 금융소득을 50:50으로 나누면 각 개인의 1,000만 원 건보 반영 기준을 독립 판단하고, 본인 100% 배분이면 본인에게만 금융소득분 건보가 반영되는지 검증한다. 재산분은 가구 단일 과표로 유지한다.
