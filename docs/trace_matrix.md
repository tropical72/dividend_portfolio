...
| REQ-PRT-03.1 | USD/KRW 통합 자산 평가 | T-02-1.2 | test_portfolio_calc.py | Done | Pass | 4cfbb3e |
| REQ-PRT-03.3 | 자산 비중 자동 계산 (0~100%) | T-02-1.2 | test_portfolio_calc.py | Done | Pass | (Pending) |
| REQ-PRT-03.4 | 실시간 분석 결과 (예상 배당금) | T-02-1.2 | test_portfolio_calc.py | Done | Pass | (Pending) |
