...
| D-RAMS-3.3.2    | 리밸런싱/이체 시 source run-rate 비례 감소와 target DY 기반 run-rate 신규 생성을 적용               | T-01-15.1.4             | TEST-SUR-08                                                                                                      | Done        | 6db403f    | 2026.05.16 |
| D-RAMS-3.3.3    | 분배금 성장률/Stress 삭감률의 retirement config/API/Settings UI 노출                                | T-01-16.1              | TEST-UI-RULE / E2E                                                                                               | Pending     | -          | -          |
