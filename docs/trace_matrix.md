...
| D-RAMS-3.3.3    | 분배금 성장률/Stress 삭감률의 retirement config/API/Settings UI 노출                                | T-01-16.1.1 ~ T-01-16.1.3 | TEST-UI-RULE / E2E                                                                                            | Pending     | -          | -          |
| D-RAMS-3.3.4    | 신규 매수분 구조적 DY override(`distribution_yield_overrides`)의 retirement config/API/Settings 노출 | T-01-16.1.4 ~ T-01-16.1.5 | TEST-UI-RULE / E2E                                                                                            | Pending     | -          | -          |
