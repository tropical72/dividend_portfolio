...
| REQ-RAMS-7.1 | 시뮬레이션 정밀 검증 UI (상세 로그) | T-06-6.1.1 | TEST-UX-LOG | Done | f605a94 |
...
| REQ-PRT-07 | UI 가독성(Sub-Tabs) 및 명칭(Corporate) 강화 | T-02-5.1 | TEST-PRT-07 | Done | 23abcca |
| REQ-PRT-08 | 마스터 전략(Master Strategy) 구성 및 관리 | T-02-8.1 | TEST-RAMS-1.5 | Done | 23abcca |
