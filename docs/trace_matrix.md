...
| D-RAMS-3.2.2 | 문서 기준 실측 대조를 위한 실사용 API 경로 정합화 및 잔여 운영규칙 갭 정리 | T-01-11.1 ~ T-01-11.3 | TEST-SUR-08 / TEST-API-INT / TEST-SUR-10 / TEST-SUR-11 / TEST-SUR-12 | In Progress | - | 2026.05.05-20.40 |
